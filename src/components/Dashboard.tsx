      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-4xl font-bold text-gray-900">
            Voice AI
            <span className="bg-gradient-to-r from-violet-600 to-cyan-600 text-transparent bg-clip-text"> Dashboard</span>
          </h1>
          <p className="text-gray-600 mt-2">Monitor and manage your AI voice assistant</p>
        </motion.div>

        {/* Stats Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {[
            { icon: BsMicFill, title: 'Total Conversations', value: '1,234', color: 'violet' },
            { icon: BsClock, title: 'Avg. Response Time', value: '0.8s', color: 'cyan' },
            { icon: BsFileText, title: 'Messages Processed', value: '15,678', color: 'violet' },
            { icon: BsGear, title: 'Active Sessions', value: '42', color: 'cyan' },
          ].map((stat, index) => (
            <motion.div
              key={index}
              initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <div className="space-y-4">
              {[
                ...
                { time: '1 hour ago', message: 'System health check completed' },
                { time: '2 hours ago', message: 'Backup completed successfully' },
              ].map((activity, index) => (
