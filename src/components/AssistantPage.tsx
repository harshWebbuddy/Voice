...
const AssistantPage = () => {
  ...
  const[systemMessage,setSystemMessage]=useState("This is a blank template with minimal defaults, you can change the model, temperature, and messages.")
  const { showPublicKeyInvalidMessage, setShowPublicKeyInvalidMessage } =
    usePublicKeyInvalid();
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div className="bg-white rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors border border-gray-200">
                            <div className="flex flex-col h-full">
                              ...
                              <p className="text-gray-500 text-sm flex-grow">
                                ...
                                knowledge. Ideal for empathetic, efficient
                                customer support.
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="bg-white rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors border border-gray-200">
                            <div className="flex flex-col h-full">
                              ...
                              <p className="text-gray-500 text-sm flex-grow">
                                An inbound call agent example designed to
                                provide comprehensive support for SmartHome
                          ...
                          <div className="bg-white rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors border border-gray-200">
                            <div className="flex flex-col h-full">
                              ...
                              <p className="text-gray-500 text-sm flex-grow">
                                ...
                                insights into the mysteries of the natural
                                world.
                              </p>
                            </div>
                          </div>
                            ...
                            <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                              <div className="p-6">
                                ...
                                <div className="space-y-6">
                                  ...
                                  <div className="space-y-2">
                                    ...
                                    <p className="text-gray-500 text-sm mt-1">
                                      ...
                                      This helps decides the chunks that are
                                      sent to the voice provider for the voice
                                ...
                                <p className="text-gray-500 text-sm">
                                  ...
                                  while listening to make the conversation
                                  sounds natural. Default disabled
                                </p>
                              </div>
                            </div>
                          </div>
                        ...
                        <div>
                          ...
                          <div className="mb-10">
                            ...
                            <p className="text-gray-500 mb-6">
                              ...
                              voicebots to connect with Make.com or GHL
                              workflows. You can also have custom tools with
                              your own backend.
                            </p>
                                  ...
                                  <div className="flex items-start justify-between">
                                    <div className="flex items-start space-x-3">
                                      ...
                                      <div>
                                        ...
                                        <p className="text-gray-500 text-sm mt-1">
                                          This will allow the assistant to end
                                          the call from its side. (Best for
                                          gpt-4 and bigger models)
                                  ...
                                  <div className="flex items-start justify-between">
                                    <div className="flex items-start space-x-3">
                                      ...
                                      <div>
                                        ...
                                        <p className="text-gray-500 text-sm mt-1">
                                          This sets whether the assistant can
                                          dial digits on the keypad.
                                          <button className="text-teal-600 hover:text-teal-700 font-medium ml-1">
                                            Read More
                                          </button>
                                        </p>
                          ...
                          <div>
                            ...
                            <p className="text-gray-500 mb-6">
                              ...
                              assistant's capabilities. You can use your own
                              code or tools like Pipedream or Make for the
                              setup.
                            </p>
                            ...
                            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6 flex items-start">
                              ...
                              <div className="ml-3">
                                <p className="text-sm text-amber-700">
                                  ...
                                  they follow older syntax as per the OpenAI
                                  Spec. Check our{" "}
                            ...
                            <div className="bg-[#1a1a1a] rounded-lg border border-gray-800 overflow-hidden">
                              <div className="p-6">
                                <div className="mb-6">
                                  ...
                                  <p className="text-gray-400 text-sm mt-1">
                                    Evaluate if your call was successful. You
                                    can use Rubric standalone or in combination
                                    with Success Evaluation Prompt. If both are
