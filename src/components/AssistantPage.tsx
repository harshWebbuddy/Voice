...
import { publictoken, token } from "../../backend/src/token";
...
const AssistantPage = () => {
  ...
  const handleCreateAssistant = async () => {
    const payload = {
      ...
      model: {
        model: "gpt-3.5-turbo",
        provider: "azure-openai", // Default model provider
        // version: "1.0", // Optional version if applicable
      },
      voice: {
        voiceId: " ",
            ...
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div className="bg-gray-50 px-3 py-1.5 rounded-lg flex items-center border border-gray-200">
                <span className="text-sm text-gray-600 mr-2 font-mono">
                  {assistantId || "4ed0b260-6b80-4ee9-b407-ed3966f3b11"}
                </span>
                <motion.button
              ...
              >
                ...
                {selectedTab === "Voice" && (
                  <div>
                    ...
                    <p className="text-gray-500 mb-6">
                      Choose from the list of voices, or sync your voice library
                      if you aren't able to find your voice in the dropdown. If
                      you are still facing any error, you can enable custom
                      voice and add a voice ID manually.
                    </p>
                ...
                {selectedTab === "Advanced" && (
                  <div>
                    ...
                    <p className="text-gray-500 mb-6">
                      Configure advanced settings to fine-tune your assistant's
                        ...
                        <div className="p-6">
                          <div className="flex items-center justify-between mb-6">
                            <div>
                              ...
                              <p className="text-gray-500 text-sm mt-1">
                                Configure call duration and timeout parameters.
                              </p>
                            </div>
                            <div className="flex items-center space-x-2">
                        ...
                        <div className="p-6">
                          ...
                          <div className="space-y-6">
                            ...
                            <div>
                              <div className="flex items-center justify-between mb-2">
                                <label className="text-gray-300 font-medium">
                                  Success evaluation request timeout in seconds.
                                </label>
                                <span className="text-sm text-gray-400">
                                  30
                                </span>
