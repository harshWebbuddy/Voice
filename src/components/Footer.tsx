  ...
  return (
    <footer className="relative bg-black text-white/70 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 pt-20">
        {/* Navigation Grid */}
        <div className="grid grid-cols-3 gap-12 md:gap-24 justify-end md:ml-auto" style={{ maxWidth: '800px', marginLeft: 'auto' }}>
          <div>
            <motion.div
        ...
        >
          <div className="py-6 flex flex-col md:flex-row md:items-center md:justify-end gap-4 text-sm">
            ...
            <span className="md:ml-6">© {new Date().getFullYear()} VoiceAI AI Inc.</span>
          </div>
        </motion.div>

        {/* Gradient Effects */}
        <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-violet-500 to-transparent opacity-20" />
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-violet-500/10 rounded-full blur-[128px] pointer-events-none" />
      </div>
    </footer>
  );
};
